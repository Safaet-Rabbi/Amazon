  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Overview of your order management system</p>
      </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{stats?.completedOrders || 0}</dd>
                </dl>
              </div>
            </div>
          </div>
        ...
        <div className="card">
          <div className="p-6">
            ...
            <div className="text-sm text-gray-600">
              ...
              <p className="mb-2">• Ready to process orders</p>
        ...
        <div className="card">
          <div className="p-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <div className="w-2 h-2 bg-green-400 rounded-full mr-2"></div>
                <span className="text-sm text-gray-600">All Systems Go</span>
              </div>
            </div>
          </div>
        </div>
